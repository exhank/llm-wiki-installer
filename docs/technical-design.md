...
│  ├─ workflow.md                # detailed capture, ingest, export, retrieval, raw, Skills, index, and tag workflow
...
| `schema/workflow.md` | detailed capture, ingest, export, retrieval, raw authorization, Skills, index, and tag maintenance rules | writable within a clear schema/policy update task | referenced by `AGENTS.md`; keeps workflow policy progressively disclosed |
